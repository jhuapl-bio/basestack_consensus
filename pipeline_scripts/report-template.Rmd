...
mutation_table <- subset(mutation_no_low_coverage, subset=rowSums(mutation_no_low_coverage[,!select_many] != "") != 0, select=!select_many)
mutation_bool <- subset(mutation_no_low_coverage_bool, subset=rowSums(mutation_no_low_coverage_bool[,!select_many] > 0) != 0, select=!select_many)
...
if(sum(select_many)>0) {
  ...
  new_cols <- subset(mutation_no_low_coverage, subset=rowSums(mutation_no_low_coverage[,!select_many] > 0) != 0, select=select_many)
  if(dim(new_cols)[2] > 0) {
    if(dim(new_cols)[2] == 1) {
  ...
  new_cols <- subset(mutation_no_low_coverage_bool, subset=rowSums(mutation_no_low_coverage_bool[,!select_many] > 0) != 0, select=select_many)
  if(dim(new_cols)[2] > 0) {
