...
snpeff_colors <- c("intergenic_region" = cols[1], "missense_variant" = cols[2], "synonymous_variant" = cols[3], "stop_gained" = cols[4], "start_lost" = cols[6], "ambiguous" = "white", "none" = "white")
...
#                      fill = rep(c('#2ca25f', '#99d8c9'), 10)[seq(1, length(genome_ref$genes))],
  ...
  rename_sel <- snpeff_subset$ANN %in% c("intergenic_region")
