...
print("while read barcode name; do")
print("  artic guppyplex \\")
print("    --skip-quality-check \\")
print(paste0("    --min-length ",filter_min," \\"))
print(paste0("    --max-length ",filter_max," \\"))
print("    --directory \"$demux_dir\"/\"$barcode\" \\")
print("    --prefix \"$gather_dir\"/\"$name\"")
print("done < \"$manifest\"")
```
