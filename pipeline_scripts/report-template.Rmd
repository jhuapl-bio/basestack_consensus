...
for(i in seq_along(dimnames(depth_plot_mean)[[1]])) {
  ...
  low_coverage_regions[sample_barcode][[1]][seq(amplicons$primer_r_start[98], 29903, 1)] <- TRUE
}
...
snpeff_colors <- c("intergenic_region" = cols[1], "missense_variant" = cols[2], "synonymous_variant" = cols[3], "stop_gained" = cols[4], "start_lost" = cols[6], "ambiguous" = "white", "none" = "gray70")
