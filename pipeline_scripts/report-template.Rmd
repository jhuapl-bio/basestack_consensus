...
annotation_snp <- data.frame(SnpEff = snpeff_annotations, clade.defining = factor(combined_rows %in% common_positions@fix[,2][common_positions@gt[,5]=="YES"]), common.snp = factor(combined_rows %in% common_positions@fix[,2][common_positions@gt[,6]=="YES"]))
...
annotation_colors <- list(Flag = flagColors[flagColors != flagColors["NA"]], clade.defining = c("yes"="#000000", "no"="#FFFFFF"), common.snp = c("yes"="#000000", "no"="#FFFFFF"), Variants = c("#FFFFFF", "gray30", "gray70"), SnpEff = snpeff_colors)
