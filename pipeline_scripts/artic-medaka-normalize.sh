...
working_dir="/home/idies/workspace/Temporary/ernluaw1/scratch/${runID}_test-normalize_try3"
...
# software
JAVA_PATH=/home/idies/workspace/Storage/ernluaw1/persistent/bin/jdk-14.0.1/bin
samtools_path=$HOME/workspace/Storage/ernluaw1/persistent/bin/samtools-1.10/bin
NormalizeCoveragePath=/home/idies/workspace/Storage/ernluaw1/persistent/bin/CoverageNormalization
...
$JAVA_PATH/java -cp $NormalizeCoveragePath/src NormalizeCoverage input=$normalize_dir/${name}_${barcode}/$align_out
